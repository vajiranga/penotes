<template>
  <q-page class="q-pa-md q-pa-lg-xl bg-grey-1">
    ...
    <!-- Meet the Admin Team Section -->
    <div class="row q-mt-xl q-mb-md">
      <div class="col-12 text-center">
        <h4 class="text-weight-bold text-grey-9 q-my-none">Meet the Admin Team</h4>
        <p class="text-subtitle1 text-grey-6 q-mt-sm">The dedicated people behind Campus Notes.</p>
      </div>
    </div>
